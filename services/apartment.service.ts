...
export const apartmentService = {
  ...
  async getById(id: number) {
    ...
    return {
      ...apartment,
      sqm: apartment.sqm != null ? Number(apartment.sqm) : null,
      priceSqm: apartment.priceSqm != null ? Number(apartment.priceSqm) : null,
      totalPrice: apartment.totalPrice != null ? Number(apartment.totalPrice) : null,
      totalPaid: apartment.totalPaid != null ? Number(apartment.totalPaid) : null,
      balanceRemaining: apartment.balanceRemaining != null ? Number(apartment.balanceRemaining) : null,
      total_price: totalPrice,
      balance,
      ...
      buyer_address: apartment.buyerAddress ?? null,
      other_buyers: apartment.otherBuyers ?? null,
      payment_schedule: apartment.paymentSchedule ?? null,
      balance_remaining: apartment.balanceRemaining != null ? Number(apartment.balanceRemaining) : null,
